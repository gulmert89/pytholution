...
# For some time now, I was wondering how one can give multiple inputs divided by spaces, i.e 1 3 12 150 42. I came up with .split() module to do that and it fit to this problem nice. Maybe there exists a different input() for providing multiple inputs. I won't use my Googling skills at once.
# Note to myself:
